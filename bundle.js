...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_decko__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_decko___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_decko__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ListMockup__ = __webpack_require__(4);
...
let App = (_class = class App extends __WEBPACK_IMPORTED_MODULE_0_preact__["Component"] {
  constructor(...args) {
    var _temp;

    return _temp = super(...args), this.state = { defaults: [], loaded: [], notify: false }, _temp;
  }

  loadItems() {
    __WEBPACK_IMPORTED_MODULE_1_electron__["ipcRenderer"].send('load-templates');
    __WEBPACK_IMPORTED_MODULE_1_electron__["ipcRenderer"].on('template-list', (store, data) => {
    ...
    __WEBPACK_IMPORTED_MODULE_1_electron__["ipcRenderer"].on('update-downloaded', () => {
      this.setState({
        notify: true
      });
    });
  ...
  handleInstall(e) {
    __WEBPACK_IMPORTED_MODULE_1_electron__["ipcRenderer"].send('install-update');
  }
  ...
  render({}, { defaults, loaded, notify }) {
    return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
      'div',
      null,
      notify ? __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
        'div',
        { className: 'w-100 pv2 ph4 tc black white pointer', onClick: this.handleInstall, style: 'background:#1880F9' },
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_3__ListMockup__["a" /* default */], { name: 'Default Mockups', items: defaults }),
        loaded.length > 0 ? __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_3__ListMockup__["a" /* default */], { name: 'Your Mockups', items: loaded }) : null
      )
    );
  }
}, (_applyDecoratedDescriptor(_class.prototype, 'handleInstall', [__WEBPACK_IMPORTED_MODULE_2_decko__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, 'handleInstall'), _class.prototype)), _class);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_decko__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_decko___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_decko__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ListMockup; });
var _desc, _value, _class;
...
const ListItem = (_ref) => {
  let { name, thumb, imgSizes } = _ref,
      props = _objectWithoutProperties(_ref, ['name', 'thumb', 'imgSizes']);

  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
    'li',
    _extends({ className: 'list db fl w-third pr3 pl3 pb3' }, props),
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])('img', { src: thumb, className: 'img w-100 ba bw1', style: 'height:134px;' }),
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
      'h3',
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
      'p',
      { className: 'db tc ma0 pa0 o-40 f6 fw3', style: 'letter-spacing:0.05em' },
      imgSizes
    )
  );
};
...
let ListMockup = (_class = class ListMockup extends __WEBPACK_IMPORTED_MODULE_0_preact__["Component"] {
  ...
  render({ name, items }) {
    return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
      'div',
      null,
      name ? __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
        'h4',
        {
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
        'ul',
        { className: 'pa0 ma0 list w-100 cf' },
        items.map(template => {
...
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["render"])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_1__App__["a" /* default */], null), document.body);
